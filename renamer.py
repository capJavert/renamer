...
@click.command()
@click.option('--path', default=".", help='Path to directory where files/directories '
                                          'you want renamed are located. Defaults to '
                                          'current directory if not set. ')
@click.option('--change', default="", help='Part of the file/directory name you want to replace.')
